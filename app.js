...
app.post("/",function(req,res){
    ...
    const url ="https://api.openweathermap.org/data/2.5/weather?q="+cityname+"&units=metric&appid=2ee793d3942d5f9e4e0dea765388ba1d#";
...
// instead of console.logging response we can console log part of it as console.log(response.serverstatus)
        ...
        response.on("data",function(data){
            ...
            // this link and above link are both you can find on openweather api


            res.write("<h1>tempreture in "+cityname+" is "+weathertemp+"degree calcius.</h1>")
